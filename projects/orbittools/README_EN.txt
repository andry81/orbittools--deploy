...
/<root>
  ...
  |     |
  |     +-/orbittools - the project deploy scripts represented a repository as a
  |                   subdirectory
  |
  +-/_orbittools    - the root of the project with source working copies
